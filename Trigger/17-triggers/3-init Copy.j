...
function Trig_PvP_Battle_Actions takes nothing returns nothing
	if(Trig_PvP_Battle_Func001C())then
		...
		call PlaySoundBJ(udg_sound08)
		call DisplayTextToForce(GetPlayersAll(),("|cffa0966dPvP Battle: "+(GetPlayerName(GetOwningPlayer(udg_units03[1]))+(" Versus "+(GetPlayerName(GetOwningPlayer(udg_units03[2]))+"!!")))))
