library ShowPlayerLeavesGame initializer init requires Scoreboard

    private function ShowPlayerLeavesGameActions takes nothing returns nothing
    ...
    private function init takes nothing returns nothing
        ...
        call TriggerAddAction(playerLeavesGameTrigger, function ShowPlayerLeavesGameActions)
