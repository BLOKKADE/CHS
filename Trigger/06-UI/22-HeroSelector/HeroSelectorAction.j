...
//This runs before the box is created with that the system has the needed data right when it is needed.
    ...
    public function InitHeroes takes nothing returns nothing
        ...
        set HeroSelectorUnitCode[40] = TAUREN_UNIT_ID
        set HeroSelectorUnitCode[41] = THUNDER_WITCH_UNIT_ID
        set HeroSelectorUnitCode[42] = TIME_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[43] = TINKER_UNIT_ID
        set HeroSelectorUnitCode[44] = TROLL_BERSERKER_UNIT_ID
        set HeroSelectorUnitCode[45] = TROLL_HEADHUNTER_UNIT_ID
        set HeroSelectorUnitCode[46] = URSA_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[47] = WAR_GOLEM_UNIT_ID
