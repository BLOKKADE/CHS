...
//This runs before the box is created with that the system has the needed data right when it is needed.
    ...
    public function InitHeroes takes nothing returns nothing
        ...
        set HeroSelectorUnitCode[11] = DEADLORD_UNIT_ID
        set HeroSelectorUnitCode[12] = DEMON_HUNTER_UNIT_ID
        set HeroSelectorUnitCode[13] = DOOM_GUARD_UNIT_ID
        ...
        set HeroSelectorUnitCode[19] = HUNTRESS_UNIT_ID
        set HeroSelectorUnitCode[20] = LICH_UNIT_ID
        set HeroSelectorUnitCode[21] = LIEUTENANT_UNIT_ID
        set HeroSelectorUnitCode[22] = MAULER_UNIT_ID
        set HeroSelectorUnitCode[23] = MEDIVH_UNIT_ID
        set HeroSelectorUnitCode[24] = MORTAR_TEAM_UNIT_ID
        //set HeroSelectorUnitCode[25] = MURLOC_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[25] = MYSTIC_UNIT_ID
        set HeroSelectorUnitCode[26] = NAGA_SIREN_UNIT_ID
        set HeroSelectorUnitCode[27] = OGRE_MAGE_UNIT_ID
        set HeroSelectorUnitCode[28] = OGRE_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[29] = ORC_CHAMPION_UNIT_ID
        set HeroSelectorUnitCode[30] = PIT_LORD_UNIT_ID
        set HeroSelectorUnitCode[31] = PYROMANCER_UNIT_ID
        set HeroSelectorUnitCode[32] = RANGER_UNIT_ID
        set HeroSelectorUnitCode[33] = ROCK_GOLEM_UNIT_ID
        set HeroSelectorUnitCode[34] = SATYR_TRICKSTER_UNIT_ID
        set HeroSelectorUnitCode[35] = SEER_UNIT_ID
        set HeroSelectorUnitCode[36] = SKELETON_BRUTE_UNIT_ID
        set HeroSelectorUnitCode[37] = SORCERER_UNIT_ID
        //set HeroSelectorUnitCode[39] = STOMP_TREE_UNIT_ID
        set HeroSelectorUnitCode[38] = TAUREN_UNIT_ID
        set HeroSelectorUnitCode[39] = THUNDER_WITCH_UNIT_ID
        set HeroSelectorUnitCode[40] = TIME_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[41] = TINKER_UNIT_ID
        set HeroSelectorUnitCode[42] = TROLL_BERSERKER_UNIT_ID
        set HeroSelectorUnitCode[43] = TROLL_HEADHUNTER_UNIT_ID
        set HeroSelectorUnitCode[44] = URSA_WARRIOR_UNIT_ID
        set HeroSelectorUnitCode[45] = WAR_GOLEM_UNIT_ID
        //set HeroSelectorUnitCode[48] = WARLOCK_UNIT_ID
        set HeroSelectorUnitCode[46] = WITCH_DOCTOR_UNIT_ID
        set HeroSelectorUnitCode[47] = WOLF_RIDER_UNIT_ID
        set HeroSelectorUnitCode[48] = YETI_UNIT_ID
