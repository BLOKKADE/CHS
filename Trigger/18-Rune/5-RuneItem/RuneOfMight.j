library MightRune requires Utility, TempStateBonus
    ...
    function MightRune takes nothing returns boolean
        ...
        call TempBonus.create(u, BONUS_STRENGTH, 50 * power, 10 * power, Runes[Might_Rune_Id])
        call TempBonus.create(u, BONUS_AGILITY, 50 * power, 10 * power, Runes[Might_Rune_Id])
        call TempBonus.create(u, BONUS_INTELLIGENCE, 50 * power, 10 * power, Runes[Might_Rune_Id])
        set u = null
        return false
    endfunction
endlibrary