     ...
     elseif TypeHero == 'O003' then  
            ...
            loop
                ...
                if RandomI == 1 then
                    ...
                    call SetHeroStr(UnitHero,GetHeroStr(UnitHero,false)+i ,false) 
                    call UpdateBonus(UnitHero, 0, i)
                elseif RandomI == 2 then
                    set i = GetRandomInt(1,19)
                    call SetHeroAgi(UnitHero,GetHeroAgi(UnitHero,false)+i,false)   
                    call UpdateBonus(UnitHero, 1, i)
                elseif RandomI == 3 then    
                    set i = GetRandomInt(1,19)
                    call SetHeroInt(UnitHero,GetHeroInt(UnitHero,false)+i,false)   
                    call UpdateBonus(UnitHero, 2, i)
                endif                
      ...
      elseif TypeHero == 'H000' then         
        ...
        elseif TypeHero == 'H017' then
         ...
         loop
            ...
            call UpdateBonus(UnitHero, 0, 16)   
            set LastLvlHero[Pid] = LastLvlHero[Pid] + 1
        endloop     
