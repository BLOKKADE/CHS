...
//===========================================================================
function InitTrig_ItemBonus takes nothing returns nothing
    set gg_trg_ItemBonus = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_ItemBonus, EVENT_PLAYER_UNIT_DROP_ITEM )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_ItemBonus, EVENT_PLAYER_UNIT_PICKUP_ITEM )
    call TriggerAddAction( gg_trg_ItemBonus, function Trig_ItemBonus_Actions )
endfunction
