library Hints initializer init
    ...
    private function init takes nothing returns nothing
        ...
        set Hints[4]= "The |cffec6645Maximum level|r of all abilities is |cff45ec5330|r! Unless you're playing as the |cff45c5ecTauren|r."
        ...
        set limit1 = 15
        set Hints[16]= "You receive gold when you win in Pvp!"
        set limit2 = 16
        set Hints[17]= "Players surviving all levels will settle the score in a battle royal."
        set limit3 = 17
