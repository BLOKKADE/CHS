library LearnAbility initializer init requires RandomShit, Functions, CustomEvent, AbilityCommand
    ...
    private function init takes nothing returns nothing
        ...
        call TriggerAddCondition(LearnAbilityTrigger,Condition(function Trig_Learn_Ability_Conditions))
        call TriggerAddAction(LearnAbilityTrigger,function Trig_Learn_Ability_Actions)
    endfunction
