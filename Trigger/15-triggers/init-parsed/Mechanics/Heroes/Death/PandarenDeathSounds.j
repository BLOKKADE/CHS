library PandarenDeathSounds initializer init requires RandomShit, PetDeath
    ...
    private function PandarenDeathSoundsActions takes nothing returns nothing
        ...
        set udg_sounds01[0] = udg_sound17
        set udg_sounds01[1] = udg_sound18
        set udg_sounds01[2] = udg_sound19
        set udg_sounds01[3] = udg_sound20
        set udg_sounds01[4] = udg_sound21
        set udg_sounds01[5] = udg_sound22
        set udg_sounds01[6] = udg_sound23
        set udg_sounds01[7] = udg_sound24
    endfunction
