library SetupPlayerArenas initializer init requires RandomShit
    ...
    private function SetupPlayerArenasActions takes nothing returns nothing
        ...
        set PlayerArenaRectCenters[0] = GetRectCenter(PlayerArenaRects[1])
        set PlayerArenaRectCenters[1] = GetRectCenter(PlayerArenaRects[2])
        set PlayerArenaRectCenters[2] = GetRectCenter(PlayerArenaRects[3])
        set PlayerArenaRectCenters[3] = GetRectCenter(PlayerArenaRects[4])
        set PlayerArenaRectCenters[4] = GetRectCenter(PlayerArenaRects[5])
        set PlayerArenaRectCenters[5] = GetRectCenter(PlayerArenaRects[6])
        set PlayerArenaRectCenters[6] = GetRectCenter(PlayerArenaRects[7])
        set PlayerArenaRectCenters[7] = GetRectCenter(PlayerArenaRects[8])
    endfunction
