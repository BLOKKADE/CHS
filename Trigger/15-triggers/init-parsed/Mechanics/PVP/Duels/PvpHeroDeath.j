library PvpHeroDeath initializer init requires RandomShit, PlayerTracking, CreepDeath, AchievementsFrame, UnitFilteringUtility, OldInitialization, PvpHelper, VotingResults, PlayerHeroDeath
    ...
    private function EndDuelActionsForWinningPlayer takes nothing returns nothing
        ...
        if (duelGame.isOddDuel or SimultaneousDuelMode == 1 or DuelGameList.size() == 1) then // No simultaneous duels or there is only one duel (Only 2 people in game, or odd player duel)
