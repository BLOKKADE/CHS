library AncientStaff requires DummyOrder, Cooldown, CustomState, GetRandomUnit, DummyOrder
    ...
    function AncientStaff takes unit u returns nothing
        ...
        call TempBonus.create(target, BONUS_MAGICRES, 0 - (GetUnitCustomState(target, BONUS_MAGICRES)* CalculateReduction(GetUnitITemTypeCount(u, ANCIENT_STAFF_ITEM_ID))), 5, 'A094')
        set target = null
    endfunction
endlibrary