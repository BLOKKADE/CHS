...
function Trig_AbilityData_Actions takes nothing returns nothing
call InitDataA1()
call InitDataRA2()
endfunction
...
function InitTrig_AbilityData takes nothing returns nothing
    ...
    call TriggerRegisterTimerEventSingle( gg_trg_AbilityData, 0.00 )
    call TriggerAddAction( gg_trg_AbilityData, function Trig_AbilityData_Actions )
endfunction
