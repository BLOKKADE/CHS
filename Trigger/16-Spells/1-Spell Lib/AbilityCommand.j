library AbilityCommand initializer init requires AbilityData, CastSpellOnTarget
    globals
    ...
    function AbilityCommandAction takes nothing returns boolean
        ...
        call BJDebugMsg("cast: " + GetObjectName(abilId) + ", assoc: " + GetObjectName(CheckAssociatedSpell(u, abilId)))
