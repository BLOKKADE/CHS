...
function Trig_Spell12_Actions takes nothing returns nothing
    ...
    if GetUnitTypeId(u2) == 'N00R' then
        call USOrderA(u2,GetUnitX(u2),GetUnitY(u2),'A035',"fanofknives",  RMaxBJ(7, GetAttackDamage(attackerHero)* (0.095 + (0.005 * GetHeroLevel(attackerHero)))) , ConvertAbilityRealLevelField('Ocl1') )
    endif
...
//===========================================================================
function InitTrig_AttackController takes nothing returns nothing
    set gg_trg_AttackController = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_AttackController, EVENT_PLAYER_UNIT_ATTACKED )
    call TriggerAddAction( gg_trg_AttackController, function Trig_Spell12_Actions )
endfunction
