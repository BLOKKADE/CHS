library HeroData initializer init
    ...
    private function init takes nothing returns nothing
        ...
        call SaveStr(HT_data,ABOMINATION_UNIT_ID,2, "|cff00ffffPassive|r: Disease Cloud: Damages nearby enemies every second. ")
        ...
        call SaveStr(HT_data,DEMON_HUNTER_UNIT_ID,3, "|cffffff00Level Up Bonus|r: Feedback: +20 mana burned." )                    
        ...
        call SaveStr(HT_data,TAUREN_UNIT_ID,2, "|cff00ffffPassive|r: Spirit Mage: Spells in the Active Spells I shop can go up to level 40 through its level up bonus and give +30 Rune Power.")
        ...
        call SaveStr(HT_data,PIT_LORD_UNIT_ID,2, "|cff00ffffPassive|r: Hellforged: Starts with Absolute Fire. 1 magic power increases physical damage dealt by 1%. |cffc0c0c0Hellforged and Absolute Fire become 25% less effective for every |r [|cff00f7ffWater|r] |cffc0c0c0spell learned.|r")
        ...
        call SaveStr(HT_data,THUNDER_WITCH_UNIT_ID,2, "|cff00ffffPassive|r: Thunder Bolt: Damages 2 nearby enemies every second. [|cff96ffffStable|r]. Thunder Bolt is affected twice by magic power.")
        ...
        call SaveStr(HT_data,BLADE_MASTER_UNIT_ID,2, "|cff00ffffPassive|r: Bladestorm: Every 9 attacks it creates a Bladestorm, dealing 50% of its attack damage to nearby enemies as physical damage.")
        ...
        call SaveStr(HT_data,SKELETON_BRUTE_UNIT_ID,2, "|cff00ffffPassive|r: Reinforced Bone: When the Hero takes 30% or more of its max hit points in damage at once it cannot take damage again for 1 second. 10 seconds cooldown. [|cff96ffffStable|r]. When one of its summons die the Hero restores 2% of its max hit points and the summon explodes, dealing 50 damage to enemies.")
        ...
        call SaveStr(HT_data,SORCERER_UNIT_ID,2, "|cff00ffffPassive|r: Lightning Strike: Damages 3 nearby enemies whenever the Hero casts a spell. ")
        ...
        call SaveStr(HT_data,URSA_WARRIOR_UNIT_ID,2, "|cff00ffffPassive|r: Bleed: Every time it attacks it causes enemies to bleed for 3 seconds, dealing 30% of its attack damage per second. ")
        ...
        call SaveStr(HT_data,RANGER_UNIT_ID,2, "|cff00ffffPassive|r: Ranger Crit: 11% chance to deal 5% bonus physical damage. [|cff80ff80Luck|r][|cff00ffffCrit|r]")
        ...
        call SaveStr(HT_data,DARK_HUNTER_UNIT_ID,2, "|cff00ffffPassive|r: Void Bash: 18% chance on attacks to deal 25 bonus damage and stun for 0.17 seconds. ")
        ...
        call SaveStr(HT_data,DOOM_GUARD_UNIT_ID,2, "|cff00ffffPassive|r: Hellfire: Deals initial damage and damage per second to nearby enemies for 8 seconds, every 8 seconds. [|cff96ffffStable|r]")
        ...
        call SaveStr(HT_data,ROCK_GOLEM_UNIT_ID,2, "|cff00ffffPassive|r: Stone Edge: When the Golem is damaged it deals 50% of its block in physical damage to nearby enemy units within 400 range. 1 second cooldown. [|cff96ffffStable|r]")
        ...
        call SaveStr(HT_data,LICH_UNIT_ID,2, "|cff00ffffPassive|r: Flash Freeze: When the Hero deals magic damage it deals bonus damage in an area around the target based on 100% of its intelligence once every 6 seconds. ")
        ...
        call SaveStr(HT_data,GNOME_MASTER_UNIT_ID,2, "|cff00ffffPassive|r: Gnome Stomp: At the start of every fight it deals damage and stuns all nearby heroes for 1 second and creeps for 2 seconds. ")
        ...
        call SaveStr(HT_data,CENTAUR_ARCHER_UNIT_ID,2, "|cff00ffffPassive|r: Horsepower: Attacks deal 100% bonus damage + 6% of the targets total hit points once every 2 seconds.")
        ...
        call SaveStr(HT_data,OGRE_WARRIOR_UNIT_ID,2, "|cff00ffffPassive|r: Ogre Stomp: Once every 6 seconds when the Hero deals physical damage it damages nearby enemies for 100% of its strength and stuns them for 1 second.")
        ...
        call SaveStr(HT_data,SATYR_TRICKSTER_UNIT_ID,2, "|cff00ffffPassive|r: Trickshot: When the Satyr evades an attack it counters, dealing 100% of its attack damage back to the attacker.")
        ...
        call SaveStr(HT_data,GHOUL_UNIT_ID,2, "|cff00ffffPassive|r: Cannibal Frenzy: +2.5% of the target's maximum hit points in attack damage, this bonus damage has 100% lifesteal on it.")
        ...
        call SaveStr(HT_data,SEER_UNIT_ID,2, "|cff00ffffPassive|r: Magical Insight: The Hero's physical damage dealt becomes magic damage and its magic damage dealt becomes physical damage. |cffc0c0c0This means most spells are affected by enemy armor and not affected by the Hero's magic power.|r" )
