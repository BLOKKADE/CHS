library HeroData initializer init
    ...
    private function init takes nothing returns nothing
        ...
        call SaveStr(HT_data,'H006',2, "|cff00ffffPassive|r: Animal Affection: Summon attack damage, armor, magic power and magic resistance are increased by a percentage of the Hero's amount. [|cff9e5d07Summon|r] spells have 50% reduced cooldown. ")
        call SaveStr(HT_data,'H006',3, "|cffffff00Level Up Bonus|r: +1% Animal Affection summon stat increase." )
        ...
        call SaveStr(HT_data,'H002',3, "|cffffff00Level Up Bonus|r: (|cff68eef3Every 8 levels|r) Lightbringer: +1 point towards [|cffd2d2d2Light|r].")   
        ...
        call SaveStr(HT_data,'O003',3, "|cffffff00Level Up Bonus|r: Glow In The Dark: [|cffd2d2d2Light|r] mode: +1% armor, +20 attack damage. [|cff000000Dark|r] mode: +0.3 magic protection, +0.75 magic power." )                    
        ...
        call SaveStr(HT_data,'O002',2, "|cff00ffffPassive|r: Vampire: Lifesteal on all damage dealt by the Hero and its summons. Killing an enemy restores 10% of its maximum hit points. [|cffff9696Lifesteal|r]")
        ...
        call SaveStr(HT_data,'O005',2, "|cff00ffffPassive|r: Scorched Earth: Once every second, the Hero's attacks set the ground on fire for 2 seconds. Units within the fire have a chance to miss any damage dealt and have a higher channe to get hit by crits. [|cff96ffffStable|r] The Pyromancer's attacks deal damage in a line.")
        call SaveStr(HT_data,'O005',3, "|cffffff00Level Up Bonus|r: +35 maximum attack damage. Scorched Earth: +0.5% miss chance, +0.1% crit chance. +1 area of effect." )  
        
        call SaveStr(HT_data,'O000',1, "ReplaceableTextures\\CommandButtons\\BTNSpiritWalker.blp" )       // tauren
        call SaveStr(HT_data,'O000',2, "|cff00ffffPassive|r: Spirit Mage: Spells in the Active Spells I shop can go up to level 40 through its level up bonus and give +30 Rune Power.")
        call SaveStr(HT_data,'O000',3, "|cffffff00Level Up Bonus|r: (|cff68eef3Every 2 levels|r) Increases the level of all spells from Active Spells I by 1." )
        
        call SaveStr(HT_data,'O008',1, "ReplaceableTextures\\CommandButtons\\BTNDruidOfTheTalon.blp" )       // Mystic
        call SaveStr(HT_data,'O008',2, "|cff00ffffPassive|r: Faerie Friend: At the start of every round the Mystic summons an invulnerable Faerie Dragon to aid it in battle.")
        call SaveStr(HT_data,'O008',3, "|cffffff00Level Up Bonus|r: +40 summon damage. Faerie Dragon: +3% attack speed. (|cff68eef3Every 3 levels|r) increases Faerie Dragon damage." )
        ...
        call SaveStr(HT_data,'O007',3, "|cffffff00Level Up Bonus|r: Hellforged: +0.5% Absolute Fire magic power bonus." )
            
        call SaveStr(HT_data,'O001',1, "ReplaceableTextures\\CommandButtons\\BTNSorceress.blp" )       // Thunder Witch
        call SaveStr(HT_data,'O001',2, "|cff00ffffPassive|r: Thunder Bolt: Damages 2 nearby enemies every second. [|cff96ffffStable|r]. Thunder Bolt is affected twice by magic power.")
        ...
        call SaveStr(HT_data,'N00K',3, "|cffffff00Level Up Bonus|r: Bladestorm: +35 damage, +3 area of effect. (|cff68eef3Every 20 levels|r) reduces attacks required by 1." )
                                                    
        call SaveStr(HT_data,'N024',1, "ReplaceableTextures\\CommandButtons\\BTNChaosGrom.blp" )       // Grom
        call SaveStr(HT_data,'N024',2, "|cff00ffffPassive|r: Valiant Strike: All damage dealt by the Hero and its summons have 20% of the Hero's strength added to it.")
        call SaveStr(HT_data,'N024',3, "|cffffff00Level Up Bonus|r: Valiant Strike: +1% damage from strength. +3 armor and +6 hit point regeneration." )
        ...
        call SaveStr(HT_data,'N00P',3, "|cffffff00Level Up Bonus|r: (|cff68eef3Every 3 levels|r) Increases the level of all summons by 1." )
        ...
        call SaveStr(HT_data,'N00Q',3, "|cffffff00Level Up Bonus|r: +10 attack damage." )
        ...
        call SaveStr(HT_data,'O006',3, "|cffffff00Level Up Bonus|r: (|cff68eef3Every 25 levels|r) Absolute Magic: Gets a free point towards all elements he has Absolute Spells for. (|cff68f386Every 20 levels|r) Gets a bonus Absolute slot. (max 10)" ) 
        ...
        call SaveStr(HT_data,'H017',2, "|cff00ffffPassive|r: Stone Edge: When the Golem is damaged it deals 50% of its block in physical damage to nearby enemy units within 400 range. 1 second cooldown. [|cff96ffffStable|r]")
        call SaveStr(HT_data,'H017',3, "|cffffff00Level Up Bonus|r: Stone Edge: +1% block damage. +1% block." )       
        ...
        call SaveStr(HT_data,'O00B',2, "|cff00ffffPassive|r: Yeti Strength: Gives the Hero +20 strength if it hass less than 50 armor. Gains +10% strength and +10% armor limit from its passive for every [|cff8080ffCold|r] spell it has.")
        call SaveStr(HT_data,'O00B',3, "|cffffff00Level Up Bonus|r: Yeti Strength: +20 bonus strength, +2 armor limit." )
        ...
        call SaveStr(HT_data,'H01I',2, "|cff00ffffPassive|r: Banshee's Curse: The Hero's mana is increased by 75% of its maximum hit points. When the Hero takes damage its mana is reduced instead of its hit points. When it reaches 0 mana it dies." )
        ...
        call SaveStr(HT_data,'H01L',2, "|cff00ffffPassive|r: Magical Insight: The Hero's physical damage dealt becomes magic damage and its magic damage dealt becomes physical damage. |cffc0c0c0This means most spells are affected by enemy armor and not affected by the Hero's magic power.|r" )
    
        call SaveStr(HT_data,'H00A',1, "ReplaceableTextures\\CommandButtons\\BTNHeroTaurenChieftain.blp" )       //Arena master
        call SaveStr(HT_data,'H00A',2, "|cff00ffffPassive|r: Passionate Student: All Rings in PVE Shop I are twice as effective.")
