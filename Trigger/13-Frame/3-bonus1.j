...
function Init_Hero_data takes nothing returns nothing
    ...
    call SaveStr(HT_data,'N00O',2, "|cff00ffffPassive|r: Skeleton Army: Summons a skeleton every time it kills an enemy unit. |cffffff00Level Up Bonus|r: +2 armor, +5 summon armor." )
