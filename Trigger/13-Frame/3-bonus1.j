library HeroData initializer init
    ...
    private function init takes nothing returns nothing
        ...
        call SaveStr(HT_data,'U000',2, "|cffffff00Level Up Bonus|r: +20 agility if the Hero's agility is lower than twice its Strength. +10 agility if the Hero's agility is lower than its strength. +5 agility if neither of those are true." )
