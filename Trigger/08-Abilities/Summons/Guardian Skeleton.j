library GuardianSkeleton requires CustomState, SpellFormula
    function GuardianSkeletonStats takes unit u, integer totalLevel returns nothing
        ...
        call AddUnitCustomState(u, BONUS_MAGICRES,4 * totalLevel)
    endfunction
endlibrary