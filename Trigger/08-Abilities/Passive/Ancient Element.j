library AncientElement initializer init requires RandomShit, AbsoluteElements, AreaDamage, Cooldown
    ...
    function UseAncientElement takes unit caster, integer level returns nothing
        ...
        call CreateTextTagTimerColor(GetFullElementText(elementId),1,GetUnitX(caster),GetUnitY(caster),80,1,255,255,255)
        call AreaDamage(caster, GetUnitX(caster), GetUnitY(caster), GetSpellValue(40, 5, level), 600, false, element, true, false)
