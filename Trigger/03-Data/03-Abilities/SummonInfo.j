library SummonInfo initializer init requires Locust
    ...
    private function SetupSummonInfo takes nothing returns nothing
        ...
        call SetSummonInfo(PRAWN_1_UNIT_ID, SUMMON_PRAWNS_ABILITY_ID, SummonStatCode.PrawnStats)
        ...
        call SetSummonInfo(TENTACLE_1_UNIT_ID, SUMMON_TENTACLE_ABILITY_ID, SummonStatCode.TentacleStats)
        ...
        call SetSummonInfo(PHOENIX_1_UNIT_ID, SUMMON_PHOENIX_ABILITY_ID, SummonStatCode.PhoenixStats)
        call SetSummonInfo(INFERNAL_1_UNIT_ID, SUMMON_INFERNO_ABILITY_ID, SummonStatCode.InfernoStats)
        call SetSummonInfo(LAVA_SPAWN_1_UNIT_ID, SUMMON_LAVA_SPAWN_ABILITY_ID, SummonStatCode.LavaSpawnStats)
        call SetSummonInfo(POCKET_FACTORY_1_UNIT_ID, SUMMON_POCKET_FACTORY_ABILITY_ID, SummonStatCode.PocketFactoryStats)
        call SetSummonInfo(CLOCKWORK_GOBLIN_1_UNIT_ID, SUMMON_POCKET_FACTORY_ABILITY_ID, SummonStatCode.ClockwerkGoblinStats)
        call SetSummonInfo(PARASITE_1_UNIT_ID, PARASITE_ABILITY_ID, SummonStatCode.ParasiteStats)
        call SetSummonInfo(CARRION_BEETLE_1_UNIT_ID, SUMMON_CARRION_BEETLES_ABILITY_ID, SummonStatCode.CarrionBeetleStats)
        ...
        call SetSummonInfo(BONE_ARMOR_SKELETON_UNIT_ID, 0, SummonStatCode.GuardianSkeletonStats)
