library HeroPassiveDesc initializer init requires HeroLvlTable, EconomyCreepBonus, Glory, GetObjectElement
    ...
    private function SetupHeroPassives takes nothing returns nothing
        ...
        call InitHeroDesc(STOMP_TREE_UNIT_ID, HeroPassive_Lvlup, "|cffffff00Level Up Bonus|r: (|cff68eef3Every 65 levels|r) +1 [|cff008000Wild|r] element. Gains special abilities: Level 125: [|cff9e5d07Summon|r] units can walk through each other. Level 150: Pull/Push Immunity. Level 175: +1% Max HP regeneration.")
    endfunction
