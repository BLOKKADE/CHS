library HeroPassiveDesc initializer init requires HeroLvlTable, EconomyCreepBonus, Glory, GetObjectElement
    globals
        ...
        integer HeroPassive_SummonLimit = 4 
        integer HeroPassive_Difficulty = 5
    endglobals
    ...
    function GetHeroTooltip takes unit playerHero returns string
        ...
        // Add Summon Limit to tooltip
        set temp = GetHeroPassiveDescription(GetUnitTypeId(playerHero), HeroPassive_SummonLimit)
        if temp != "" and temp != null then
            set tooltip = tooltip + "|n|cff00ff80Base Summon Limit|r: " + temp
        endif
    ...
    private function SetupHeroPassives takes nothing returns nothing
        call InitHeroDesc(LIEUTENANT_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(LIEUTENANT_UNIT_ID, HeroPassive_SummonLimit, "24") 

        call InitHeroDesc(ABOMINATION_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(MAULER_UNIT_ID, HeroPassive_SummonLimit, "24")
    
        call InitHeroDesc(BLOOD_MAGE_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(BLOOD_MAGE_UNIT_ID, HeroPassive_SummonLimit, "24")
        
        call InitHeroDesc(MORTAR_TEAM_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(MORTAR_TEAM_UNIT_ID, HeroPassive_SummonLimit, "24")
                    
        call InitHeroDesc(NAGA_SIREN_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(NAGA_SIREN_UNIT_ID, HeroPassive_SummonLimit, "24")
        ...
        call InitHeroDesc(DEMON_HUNTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(DEADLORD_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(DEADLORD_UNIT_ID, HeroPassive_SummonLimit, "24")
        
        call InitHeroDesc(PYROMANCER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(PYROMANCER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(TAUREN_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(PIT_LORD_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(PIT_LORD_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(THUNDER_WITCH_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(THUNDER_WITCH_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(WOLF_RIDER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(BLADE_MASTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(BLADE_MASTER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(ORC_CHAMPION_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(TROLL_HEADHUNTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(TROLL_HEADHUNTER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(TINKER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(FALLEN_RANGER_UNIT_ID, HeroPassive_SummonLimit, "24")
        ...
        call InitHeroDesc(SORCERER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(URSA_WARRIOR_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(WAR_GOLEM_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(WARLOCK_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        call InitHeroDesc(WARLOCK_UNIT_ID, HeroPassive_Icon, "ReplaceableTextures\\CommandButtons\\BTNEredarWarlockPurple.blp" )
        call InitHeroDesc(WARLOCK_UNIT_ID, HeroPassive_Desc, "|cff00ffffPassive|r: Bloodmirror: When attacking, has a 7% chance to create an illusion that lasts 10 seconds (limit of 3 illusions). Cannot miss with attacks and spells. [|cff80ff80Luck|r]. Illusions last 10 seconds, have the same attack cooldown as the Hero, deal 100% damage, and take 200% damage.")
        ...
        call InitHeroDesc(WITCH_DOCTOR_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(RANGER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(DARK_HUNTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(DARK_HUNTER_UNIT_ID, HeroPassive_SummonLimit, "24")
        ...
        call InitHeroDesc(ROCK_GOLEM_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(COLD_KNIGHT_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        call InitHeroDesc(COLD_KNIGHT_UNIT_ID, HeroPassive_Icon, "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp" )
        call InitHeroDesc(COLD_KNIGHT_UNIT_ID, HeroPassive_Desc, "|cff00ffffPassive|r: Deep Freeze: Every 10 seconds, the Hero freezes nearby enemies within 750 range. For every [|cff8080ffCold|r] the Hero has, the freeze deals 30 |cffff00ffmagic damage|r and freezes enemies for 0.15 seconds. |n|nAfter activating a [|cff8080ffCold|r] spell, enemy heroes' spells are put on cooldown for 0.2 seconds, this has a 0.5 second cooldown per unit.")
        ...
        call InitHeroDesc(LICH_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(GNOME_MASTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(GREEDY_GOBLIN_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(CENTAUR_ARCHER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(CENTAUR_ARCHER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(OGRE_WARRIOR_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(TIME_WARRIOR_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(OGRE_MAGE_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(TROLL_BERSERKER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(TROLL_BERSERKER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(YETI_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(YETI_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(SATYR_TRICKSTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(SATYR_TRICKSTER_UNIT_ID, HeroPassive_SummonLimit, "24")
        ...
        call InitHeroDesc(MEDIVH_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cff00ff4cEASY|r" )
        ...
        call InitHeroDesc(MEDIVH_UNIT_ID, HeroPassive_SummonLimit, "24")
        ...
        call InitHeroDesc(CRYPT_LORD_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(CRYPT_LORD_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(GNOLL_WARDEN_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cffff0000HARD|r" )
        ...
        call InitHeroDesc(GNOLL_WARDEN_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(SEER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
        ...
        call InitHeroDesc(SEER_UNIT_ID, HeroPassive_SummonLimit, "24")

        call InitHeroDesc(ARENA_MASTER_UNIT_ID, HeroPassive_Difficulty, "Difficulty: |cfffff200MEDIUM|r" )
