library GloryItemCosts initializer init requires Glory
    ...
    private function SetupGloryItemCosts takes nothing returns nothing
        ...
        set GloryItemCosts[GLORY_ATTACK_DAMAGE_TOME_ITEM_ID] = 1200
        ...
        set GloryItemCosts[GLORY_MAGIC_POWER_TOME_ITEM_ID] = 1200
        set GloryItemCosts[GLORY_PHYS_POWER_TOME_ITEM_ID] = 1200
        ...
        set GloryItemCosts[PACKING_TAPE_TOME_ITEM_ID] = 10000
        ...
        set GloryItemCosts[DRIED_MUSHROOM_ITEM_ID] = 15000
    endfunction
