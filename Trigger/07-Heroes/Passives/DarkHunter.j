library DarkHunter requires ElementalAbility, RandomShit

    function DarkHunterStun takes unit source, unit target, real damage, real duration returns nothing
