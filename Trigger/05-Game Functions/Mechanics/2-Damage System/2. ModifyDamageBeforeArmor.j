scope ModifyDamageBeforeArmor initializer init
    ...
    private function ModifyDamageBeforeArmor takes nothing returns nothing
        ...
        //Strong Chestmail
        if UnitHasItemType(DamageTarget, 'I07P') and (not IsUnitType(DamageSource, UNIT_TYPE_HERO) or DamageSourceTypeId == STOMP_TREE_UNIT_ID) and GetUnitAbilityLevel(DamageSource, 'A0AQ') == 0 then
        ...
        if i1 > 0 and GetUnitAbilityLevel(DamageTarget, ENERGY_SHIELD_BUFF_ID) > 0 and GetUnitAbilityLevel(DamageSource, 'A0AQ') == 0 and r1 >= 300 then
        ...
        if i1 > 0 and BlzGetUnitAbilityCooldownRemaining(DamageTarget,ICE_FORCE_ABILITY_ID) <= 0 and GetUnitAbilityLevel(DamageSource, 'A0AQ') == 0 then
        ...
        if i1 > 0 and GetUnitAbilityLevel(DamageSource, 'A0AQ') == 0 then
