    ...
    */
    ...
    struct SuddenDeath extends array
        ...
        private method setupTimer takes nothing returns nothing
            ...
            if this.duelGame.isOddDuel or SimultaneousDuelMode == 1 or BlzForceHasPlayer(this.duelGame.team1, GetLocalPlayer()) or BlzForceHasPlayer(this.duelGame.team2, GetLocalPlayer()) then
